...
public class DirectAuthoriser implements IAuthoriser {
    ...
    private final Connection connection = Jsoup.connect(VkAPI.AUTH_BASE_URI)
            .data("scope", VkAPI.AUTH_PERMISSIONS)
            .data("redirect_uri", VkAPI.AUTH_REDIRECT_URI)
            .data("display", VkAPI.AUTH_DISPLAY)
            .data("v", VkAPI.VK_API_VERSION)
